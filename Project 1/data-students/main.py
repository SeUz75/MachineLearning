...
test_dataset_path = './TEST'  # Assuming this is your directory path
...
# Run K-Fold Training
k_fold_training(my_model, complete_dataset, k=5, n_epochs=100, patience=10, optimizer=optimizer_model,
                scheduler=scheduler)
...
class UnlabeledDataset(Dataset):
    def __init__(self, images_folder, transform=None):
        ...
        self.image_files = [os.path.join(images_folder, f) for f in os.listdir(images_folder) if
